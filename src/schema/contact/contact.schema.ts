...
const returnUpdateContactSchema: yup.SchemaOf<IContact> = yup.object().shape({
       client: yup.string().notRequired(),
       telephonesExtra: yup.array().nullable().notRequired(),
       emailsExtra: yup.array().nullable().notRequired(),
       createdAt: yup.date().notRequired(),
...
const updadteContactSchame: yup.SchemaOf<IContactUpdate> = yup.object().shape({
     nickname: yup.string().notRequired(),
     fullName: yup.string().notRequired(),
     telephone: yup
     .string()
...
export {createdContactSchema, returnContactSchema, updadteContactSchame, returnUpdateContactSchema}