...
export class createTable1679593628393 implements MigrationInterface {
    name = 'createTable1679593628393'

    public async up(queryRunner: QueryRunner): Promise<void> {
        await queryRunner.query(`CREATE TABLE "contact" ("id" uuid NOT NULL DEFAULT uuid_generate_v4(), "nickname" character varying(100) NOT NULL, "fullName" character varying(200) NOT NULL, "telephone" character varying(11) NOT NULL, "telephonesExtra" text, "email" character varying(100) NOT NULL, "emailsExtra" text, "createdAt" TIMESTAMP NOT NULL DEFAULT now(), "clientId" uuid, CONSTRAINT "UQ_0ccceae1c81156c175196e138f6" UNIQUE ("nickname"), CONSTRAINT "UQ_eff09bb429f175523787f46003b" UNIQUE ("email"), CONSTRAINT "PK_2cbbe00f59ab6b3bb5b8d19f989" PRIMARY KEY ("id"))`);
